# Generated by Django 5.2.10 on 2026-01-10 22:43
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('admin', 'Adminstrator'), ('member', 'Member')], default='member', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('priority', models.CharField(choices=[('low', 'Niedrig'), ('medium', 'Mittlere'), ('high', 'Hoch')], default='medium', max_length=10)),
